                                                        ...
                                                        if (action.InRange)
                                                        {
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                foreach (var bind in _KeyBindMap)
                                                                {
                                                                    ...
                                                                    {
                                                                     bool userdef=false;
                                                                     for(int i=0; i< dG_spells.Rows.Count; i++)
                                                                     {
                                                                                if (dG_spells.Rows[i].Cells[0].Value == null)
                                                                                    break;
                                                                                    if (dG_spells.Rows[i].Cells[0].Value.ToString()==action.Name)
                                                                        {
                                                                            GlobalApplyMapKeypadBINDLighting(
                                                                                bind.Key,
                                                                                ColorTranslator.FromHtml(dG_spells.Rows[i].Cells[1].Value.ToString()),
                                                                                false);
                                                                            userdef=true;
                                                                            break;
                                                                        }
